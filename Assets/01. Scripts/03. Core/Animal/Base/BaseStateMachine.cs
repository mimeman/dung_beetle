...
public abstract class BaseStateMachine : MonoBehaviour
{
    ...
    public abstract AnimalBaseState<AIController> PatrolState { get; }      // 필요한 요소를 찾아 탐색
    public abstract AnimalBaseState<AIController> TraceState { get; }       // 필요한 요소를 찾았다면 요소를 쫓아감
    public abstract AnimalBaseState<AIController> InteractState { get; }    // 요소와의 상호작용
