...
public class AnimalController : MonoBehaviour
{
    ...
    public BaseState<AnimalController> CurrentState { get; private set; }
    ...
    void Update()
    {
        ...
        BaseState<AnimalController> nextState = CurrentState.UpdateState(this);
        if (nextState != CurrentState)
            ChangeState(nextState);
    }

    void ChangeState(BaseState<AnimalController> newState)
    {
