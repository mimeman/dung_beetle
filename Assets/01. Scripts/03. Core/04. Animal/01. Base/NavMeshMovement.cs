...
public class NavMeshMovement : MonoBehaviour
{
    ...
    public void SetUp(AnimalConfig config, Animator animator, AnimalAnimationConfig animationConfig)
    {
        this.config = config;
    ...
    private void CorrectGroundHeight()
    {
        ...
        if (Physics.Raycast(rayOrigin, Vector3.down, out RaycastHit hit, GROUND_CHECK_DISTANCE, config.groundLayer))
        {
